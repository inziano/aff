        ...
        <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
            <div class="relative flex">
                ...
                <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">
                    <button type="button" class="block inline-flex items-center justify-center h-10 w-10 transition duration-500 ease-in-out text-white bg-gray-200 hover:bg-teal-400 focus:outline-none"@click="onSubmit">
    ...
    methods: {
      ...mapActions('MessageModule',['create']),
        ...
        onSubmit(){
            ...
            data['recipient'] = this.recipient[0]
            // Push message
