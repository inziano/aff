    ...
    <div class="w-full h-full">
        <div class="w-full h-full p-5">
            ...
            <div class="w-full flex bg-white">
                ...
                <div class="w-5/6 flex content-center">
                    ...
                    <div class="flex-grow content-center h-full p-2">
                        <filter-a v-show="years" class="ml-4" :module-name="moduleName" :filter-items="years" :filter-type="typeA" @items-filtered="filtered = true" >
                            <Icon type="ios-calendar-outline" size="16"></Icon>
                        </filter-a>
                        <filter-a  v-show="countries" class="ml-4" :module-name="moduleName" :filter-items="countries" :filter-type="typeB" @items-filtered="filtered = true" >
                            <Icon type="ios-map-outline" size="16"></Icon>
                        </filter-a>
                        <filter-a v-show="expertise" class="ml-4" :module-name="moduleName" :filter-items="expertise" :filter-type="typeC" @items-filtered="filtered = true" >
                            <Icon type="ios-briefcase-outline" size="16"></Icon>
                        </filter-a>
                        <filter-a v-show="gender" class="ml-4" :module-name="moduleName" :filter-items="gender" :filter-type="typeD" @items-filtered="filtered = true" >
            ...
            <div class="w-full h-auto flex flex-wrap pt-5 bg-gray-100 justify-center" v-if="!list && !charts">
               <profilelist-item :members = profiles ></profilelist-item>
            </div>
